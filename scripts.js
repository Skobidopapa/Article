...
function clearLoginStatus() {
    ...
    document.getElementById("about-section").style.display = "none"; // Hide about section if visible
    document.getElementById("contact-section").style.display = "none"; // Hide contact section if visible
}
